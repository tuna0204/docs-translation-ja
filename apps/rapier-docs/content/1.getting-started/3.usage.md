...
`RigidBody` can emit events like [collisions](http://localhost:3000/api/rigid-body/collisions) or [intersections](http://localhost:3000/api/rigid-body/sensor). You can use it as you would normally do using [vue emits](https://vuejs.org/guide/components/events.html#emitting-and-listening-to-events)
