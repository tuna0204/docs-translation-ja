...
| --- | --- | --- | --- |
| `type` | `JointType` | Joint type to create. | — |
| `bodies` | `[RigidBody \| null \| undefined, RigidBody \| null \| undefined]` | Two rigid bodies connected by the joint. | — |
| `params` | `(number \| number[])[]` | Joint parameters passed to Rapier joint data. | — |
| `wakeUpOnChanges` | `boolean` | Wakes up connected bodies when the joint mounts, unmounts, or updates. | `true` |