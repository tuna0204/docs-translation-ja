import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, h, resolveComponent, computed, mergeProps, unref, createVNode, resolveDynamicComponent, withCtx, renderSlot, createBlock, openBlock, getCurrentInstance, provide, cloneVNode, createElementBlock, toRef, inject, useSlots, ref, createCommentVNode, toDisplayString, hasInjectionContext, isRef, toValue, watch, onServerPrefetch, mergeModels, useModel, createTextVNode, nextTick, defineAsyncComponent, useSSRContext, shallowReactive, Suspense, Fragment, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, useTemplateRef, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, k as parseQuery, l as klona, m as defuFn, n as defu, o as hasProtocol, j as joinURL, q as isEqual, w as withQuery, t as withTrailingSlash, v as withoutTrailingSlash, x as isScriptProtocol, y as getContext, z as sanitizeStatusCode, e as createError$1, $ as $fetch$1, A as baseURL, B as createHooks, C as executeAsync, D as toRouteMatcher, E as createRouter$1 } from '../nitro/nitro.mjs';
...
import { createContext, useForwardProps, Primitive, Slot, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, useForwardPropsEmits, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, ProgressRoot, ProgressIndicator } from 'reka-ui';
...
const unhead_yyL7rmRvs6rMsM2Y9YCkoxfgomjgSHM3_XZQBawPZZM = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./index-VrubNiA8.mjs')
  },
  {
    name: "basic-lights",
    path: "/basic/lights",
    component: () => import('./index-B4siF4Mi.mjs')
  },
  {
    name: "basic-simple",
    path: "/basic/simple",
    component: () => import('./index-D7Wp9jmj.mjs')
  },
  {
    name: "loaders-gltf",
    path: "/loaders/gltf",
    component: () => import('./index-DvHk5sgi.mjs')
  },
  {
    name: "basic-primitives",
    path: "/basic/primitives",
    component: () => import('./index-DcNHSSd_.mjs')
  },
  {
    name: "misc-parent-child-Child",
    path: "/misc/parent-child/Child",
    component: () => import('./Child-C4mFYlrT.mjs')
  },
  {
    name: "misc-parent-child",
    path: "/misc/parent-child",
    component: () => import('./index-DGzo4rsl.mjs')
  },
  {
    name: "advanced-on-demand",
    path: "/advanced/on-demand",
    component: () => import('./index-BFgjUpa1.mjs')
  }
];
...
const revive_payload_server_QhHmNNULstmDMxTzfqJwmT8Q85uGSvvNFD_3Yr87JOw = /* @__PURE__ */ defineNuxtPlugin({
...
const colors_tr2vv5PaCyzl1oHqDG3UhYaKbEITcp2LXuJcS0niHb8 = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_server_oHK2IYOovDU_2g9iWUIQ_rDDOOxOSnBV6f57DSIeHV8 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugin_E2SS4wY30N1yR0vC2_MATJZCHVIoA6CgsUSHxVQ8Jsc = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const prerender_server_Z299pnZRdVAsrV5lUfoFQ__01sjIuWyW4lrcmWvu2CI = /* @__PURE__ */ defineNuxtPlugin(async () => {
  {
    return;
  }
});
const plugins = [
  unhead_yyL7rmRvs6rMsM2Y9YCkoxfgomjgSHM3_XZQBawPZZM,
  plugin,
  revive_payload_server_QhHmNNULstmDMxTzfqJwmT8Q85uGSvvNFD_3Yr87JOw,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  colors_tr2vv5PaCyzl1oHqDG3UhYaKbEITcp2LXuJcS0niHb8,
  plugin_server_oHK2IYOovDU_2g9iWUIQ_rDDOOxOSnBV6f57DSIeHV8,
  plugin_E2SS4wY30N1yR0vC2_MATJZCHVIoA6CgsUSHxVQ8Jsc,
  prerender_server_Z299pnZRdVAsrV5lUfoFQ__01sjIuWyW4lrcmWvu2CI
];
...
_sfc_main$d.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/Progress.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/Toast.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/Toaster.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/OverlayProvider.vue");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt+ui@4.5.0_@nuxt+content@3.10.0_better-sqlite3@12.5.0_magicast@0.5.1_valibot@1.2.0__4995ab990a17ff4c1f805763520f4dd9/node_modules/@nuxt/ui/dist/runtime/components/App.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_0 = Object.assign(_sfc_main$3, { __name: "UApp" });
const layouts = {
  default: defineAsyncComponent(() => import('./default-Bq9q33xr.mjs').then((m) => m.default || m)),
  home: defineAsyncComponent(() => import('./home-De2yzwrb.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Ce-B5jR_.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DJsYPlX3.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@4.1.3_@parcel+watcher@2.5.1_@types+node@24.10.4_@vue+compiler-sfc@3.5.26_better-sq_e3e7ef3ccfc905dadc8064e4eb5ee8cb/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@4.1.3_@parcel+watcher@2.5.1_@types+node@24.10.4_@vue+compiler-sfc@3.5.26_better-sq_e3e7ef3ccfc905dadc8064e4eb5ee8cb/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useAppConfig as b, useComponentUI as c, _sfc_main$d as d, entry_default as default, _sfc_main$9 as e, __nuxt_component_0$3 as f, getSlotChildrenText as g, useLocale as h, usePortal as i, _sfc_main$8 as j, useRoute as k, useState as l, useNuxtApp as m, tv as t, useHead as u };
